...
<body>
        ...
        <div class="d-flex flex-wrap">
            <div class="px-lg-4 px-md-2 px-sm-1 col-lg-4 col-md-6 col-sm-12 pb-5">
                <div class="card mx-auto no-border">
                    <img src="https://scontent-den4-1.xx.fbcdn.net/v/t1.0-9/42880975_1116623265153666_6510657429842165760_o.jpg?_nc_cat=108&_nc_ohc=T91yxD6Ma-YAX8e_iGi&_nc_ht=scontent-den4-1.xx&oh=d44790503663fe5eeea65097a83ec869&oe=5EBF8AAC" class="card-img-top rounded" alt="...">
                    <div class="card-body">
    ...
    <div class="container border-left border-danger mb-5 pt-5 mt-1 mx-auto">
        <h1 class="mx-4 mb-4">Prosthetics</h1>
        <div class="d-flex flex-wrap">
            <div class="px-lg-4 px-md-2 px-sm-1 col-lg-4 col-md-6 col-sm-12 pb-5">
                <div class="card mx-auto no-border">
                    <img src="https://scontent-den4-1.xx.fbcdn.net/v/t1.0-9/42880975_1116623265153666_6510657429842165760_o.jpg?_nc_cat=108&_nc_ohc=T91yxD6Ma-YAX8e_iGi&_nc_ht=scontent-den4-1.xx&oh=d44790503663fe5eeea65097a83ec869&oe=5EBF8AAC" class="card-img-top rounded" alt="...">
    ...
    <div class="container border-left border-info mb-5 pt-5 mt-1 mx-auto">
        <h1 class="mx-4 mb-4">General</h1>
        <div class=" d-flex flex-wrap">
            <div class="px-lg-4 px-md-2 px-sm-1 col-lg-4 col-md-6 col-sm-12 pb-5">
                <div class="card mx-auto no-border">
                    <img src="https://scontent-den4-1.xx.fbcdn.net/v/t1.0-9/42880975_1116623265153666_6510657429842165760_o.jpg?_nc_cat=108&_nc_ohc=T91yxD6Ma-YAX8e_iGi&_nc_ht=scontent-den4-1.xx&oh=d44790503663fe5eeea65097a83ec869&oe=5EBF8AAC" class="card-img-top rounded" alt="...">
    ...
    <div class="container border-left border-success mb-5 pt-5 mt-1 mx-auto">
        <h1 class="mx-4 mb-4">Large-Scale Printing</h1>
        <div class="d-flex flex-wrap">
            <div class="px-lg-4 px-md-2 px-sm-1 col-lg-4 col-md-6 col-sm-12 pb-5">
                <div class="card mx-auto no-border">
                    <img src="https://scontent-den4-1.xx.fbcdn.net/v/t1.0-9/42880975_1116623265153666_6510657429842165760_o.jpg?_nc_cat=108&_nc_ohc=T91yxD6Ma-YAX8e_iGi&_nc_ht=scontent-den4-1.xx&oh=d44790503663fe5eeea65097a83ec869&oe=5EBF8AAC" class="card-img-top rounded" alt="...">
    ...
    <div class="container border-left border-success mb-5 pt-5 mt-1 mx-auto">
        <h1 class="mx-4 mb-4">Make Mizzou</h1>
        <div class="d-flex flex-wrap">
            <div class="px-lg-4 px-md-2 px-sm-1 col-lg-4 col-md-6 col-sm-12 pb-5">
                <div class="card mx-auto no-border">
                    <img src="https://scontent-den4-1.xx.fbcdn.net/v/t1.0-9/42880975_1116623265153666_6510657429842165760_o.jpg?_nc_cat=108&_nc_ohc=T91yxD6Ma-YAX8e_iGi&_nc_ht=scontent-den4-1.xx&oh=d44790503663fe5eeea65097a83ec869&oe=5EBF8AAC" class="card-img-top rounded" alt="...">
